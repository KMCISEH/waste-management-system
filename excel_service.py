...
def export_cost_settlement_excel(data: dict):
    ...
    section_fill = PatternFill(start_color='305496', end_color='305496', fill_type='solid') # 모던 블루
    header_font = Font(name='맑은 고딕', size=10, bold=True, color='444444')
    header_fill = PatternFill(start_color='D9E1F2', end_color='D9E1F2', fill_type='solid') # 연한 블루그레이
    data_font = Font(name='맑은 고딕', size=10, color='333333')
    amount_fill = PatternFill(start_color='FFF2CC', end_color='FFF2CC', fill_type='solid') # 파스텔 옐로우
    subtotal_fill = PatternFill(start_color='E2EFDA', end_color='E2EFDA', fill_type='solid') # 파스텔 그린
